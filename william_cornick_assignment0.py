# -*- coding: utf-8 -*-
"""William Cornick - Assignment0.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14P_x5fvMEPln-Z9m4xvG3LCqQ81NE5AG
...
print(f'The air speed of an unladen European swallow is {air_speed} mph') #here's another way to do formatting
#you can use :.xf to specify x digits after the decimal place
print(f'The air speed of an unladen European swallow is {air_speed:.0f} mph')
print(f'The air speed of an unladen European swallow is {air_speed:.1f} mph')
